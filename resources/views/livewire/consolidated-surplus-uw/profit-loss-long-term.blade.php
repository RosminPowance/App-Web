    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formFilter">
                    <div class="mb-3 row">
                        <label class="col-sm-3">Production Date</label>
                        <div class="col-sm-9">
                            <div class="input-group flatpicker-calender">
                                <input class="form-control" id="datetime-local" type="date" name="PRODUCTION_DATE">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3 row">
        ...
        <div class="card">
            <div class="card-header card-no-border pb-0">
                <div class="header-top">
                    <h4 class="">Table Consolidated Surpluw UW Profit Loss Long Term</h4>
        ...
        <script>
            ...
            webix.ready(function() {
                ...
                $("#formFilter").on('submit', function(e) {
                    ...
                    let url = '{{ route('dataset.consolidated-profit-loss-long-term') }}' + "?" + serialize;
                    $$("pivot").load(url, structure)
                        .then(() => {
