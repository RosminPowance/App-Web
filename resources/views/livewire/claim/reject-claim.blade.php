    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formFilter">
                    <div class="mb-3 row">
                        <label class="col-sm-3">Start Rejected</label>
                        <div class="col-sm-9">
                            <div class="input-group flatpicker-calender">
                                <input class="form-control datetime-local" type="date" name="REJECTED_DATE">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-sm-3">End Rejected</label>
                        <div class="col-sm-9">
                            <div class="input-group flatpicker-calender">
        ...
        <div class="card">
            <div class="card-header card-no-border pb-0">
                <div class="header-top">
                    <h4 class="">Table Reject Claim</h4>
        ...
        <script>
            ...
            webix.ready(function() {
                ...
                $("#formFilter").on('submit', function(e) {
                    ...
                    let url = '{{ route('dataset.reject-claim') }}' + "?" + serialize;
                    $$("pivot").load(url, structure)
                        .then(() => {
