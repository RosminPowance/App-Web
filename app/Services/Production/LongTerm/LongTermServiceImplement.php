...
class LongTermServiceImplement extends Service implements LongTermService
{
  ...
  public function getDataset($query = null)
  {
    ...
    $columns = array(
      ...
      "IDLEADER0"                   => "MA.LEADER0",
      "IDLEADER1"                   => "MA.LEADER1",
      "IDLEADER2"                   => "MA.LEADER2",
      "IDLEADER3"                   => "MA.LEADER3",
    ...
    $builder = DB::table("Warehouse_Asm_SPK.dbo.PRODUCTION_GABUNGAN_VIEW AS A");
