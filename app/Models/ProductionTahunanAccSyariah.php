...
/**
 * Class ProductionTahunanAccSyariah
 * 
 ...
 * @property string|null $flag_reas
 *
 * @package App\Models
 */
class ProductionTahunanAccSyariah extends Model
{
	protected $table = 'production_tahunan_acc_syariah';
